...
<!-- Footer-->
<footer class="py-5 bg-secondary p-3">
    ...
    <div class="row">
      <div class="col-md-6 text-light">
        <a href="index.php" class="text-decoration-none text-white">
          <h4><span class="badge text-white bg-success">T</span>
            <span class="badge text-white bg-danger">P</span>
            <span class="badge text-white bg-warning">T</span> Shop - Cửa hàng mỹ phẩm
          </h4>
        </a>
        <p><b><i>Địa chỉ:</i></b> 18 Ung Văn Khiêm, phường Đông Xuyên, TP Long Xuyên, An Giang<br>
          <b><i>Điện thoại:</i></b> 0365102892<br>
